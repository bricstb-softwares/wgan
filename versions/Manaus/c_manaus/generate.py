...
tuning_path   = '/home/brics/public/brics_data/Manaus/manaus/models/user.joao.pinto.task.Manaus.manaus.wgan_v2_tb.r2'
dataset_name  = 'user.joao.pinto.task.Manaus.manaus.wgan_v2_tb.r2.sample_short'
image_format  = 'manaus.tb.test_{test}.sort_{sort}.ID{project_id}.png'

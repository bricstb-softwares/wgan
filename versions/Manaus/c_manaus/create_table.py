...
#dataset_name  = 'user.joao.pinto.task.Manaus.manaus.wgan_v2_tb.r2.samples'
dataset_name  = 'user.joao.pinto.task.Manaus.manaus.wgan_v2_notb.r2.samples'
